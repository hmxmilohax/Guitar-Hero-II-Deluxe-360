...
"%~dp0dependencies/dtab" -e "%~dp0\theme\init_track_theme.dtb" "%~dp0\gen\init_track_theme.dtb"
"%~dp0dependencies/dtab" -e "%~dp0\theme\init_ui_theme.dtb" "%~dp0\gen\init_ui_theme.dtb"
