...
"%~dp0dependencies/dtab" -b "%~dp0\_theme\init_fastsong.dta" "%~dp0\_theme\init_fastsong.dtb"
...
"%~dp0dependencies/dtab" -e "%~dp0\_theme\init_fastsong.dtb" "%~dp0\_build\Xbox\gen\init_fastsong.dtb"
del "%~dp0\_theme\init_ui_theme.dtb"
del "%~dp0\_theme\init_track_theme.dtb"
del "%~dp0\_theme\init_fastsong.dtb"
pause