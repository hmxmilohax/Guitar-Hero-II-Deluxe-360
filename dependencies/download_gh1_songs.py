...
try:
    import git
    print("module 'git' is installed. Downloading GHIIDX songs repo & enabling GH1DX songs for Xenia, this will take a while...")
...
gh2dx_songs_source_path = cwd.joinpath("gh1dx-360-songs")
...
if gh2dx_songs_source_path.exists():
    ...
    repo = git.Repo.clone_from("https://github.com/hmxmilohax/gh2dx-360-songs.git", gh2dx_songs_source_path, branch="gh1dx")

gh2dx_songs_source_folder = cwd.joinpath("gh1dx-360-songs/GHIDX/songs")
gh2dx_config_source_folder = cwd.joinpath("gh1dx-360-songs/GHIDX/config")
