...
try:
    import git
    print("module 'git' is installed. Downloading/enabling GH80SDX songs for Xenia, this may take some time.")
...
gh2dx_songs_source_folder = cwd.joinpath("gh2dx-360-songs/GH80SDX/songs")
gh2dx_config_source_folder = cwd.joinpath("gh2dx-360-songs/GH80SDX/config")
